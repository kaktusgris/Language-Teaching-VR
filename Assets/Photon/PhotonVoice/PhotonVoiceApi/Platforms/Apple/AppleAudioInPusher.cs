...
namespace Photon.Voice.Apple
{
    ...
    public class AppleAudioInPusher : Voice.IAudioPusher<float>
    {
        ...
        public AppleAudioInPusher(int deviceID, Voice.ILogger logger)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    Error = "Exception in AppleAudioInPusher constructor";
                }
                logger.LogError("[PV] AppleAudioInPusher: " + Error);
            }
        }
