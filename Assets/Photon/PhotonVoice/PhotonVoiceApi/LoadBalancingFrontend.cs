// -----------------------------------------------------------------------
// <copyright file="LoadBalancingFrontend.cs" company="Exit Games GmbH">
...
namespace Photon.Voice
{
    ...
    /// </summary>
    /// Transmission Channels are not for selective forwarding: use AudioGroups for that.
    ...
    /// </remarks>
    public class LoadBalancingFrontend : LoadBalancingClient, IVoiceFrontend, IDisposable
    {
        /// <summary>The <see cref="VoiceClient"></see> implementation associated with this LoadBalancingFrontend.</summary>
        ...
        /// <summary>
        /// Releases all resources used by the <see cref="LoadBalancingFrontend"/> instance.
        /// </summary>
        public void Dispose()
        {
